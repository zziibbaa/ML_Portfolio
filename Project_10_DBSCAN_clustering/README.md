...
- حذف ویژگی‌های غیرعددی برای تمرکز بر رفتار خرید  
...
الگوریتم DBSCAN با مقدار دلخواه `eps` اجرا می‌شود. این الگوریتم خوشه‌ها را بر اساس چگالی داده‌ها شناسایی کرده و نقاط نویز را نیز مشخص می‌کند. با تغییر مقدار `eps`، ساختار خوشه‌ها تغییر می‌کند و می‌توان رفتارهای مختلف مشتریان را بررسی کرد.
